...
import com.carlosreyes.almacen.core.service.ClienteService;
import com.carlosreyes.almacen.core.service.ClienteServiceImpl;
...
public class ClienteController implements Initializable {
    ...
    public void nuevo(){
        switch(tipoOperacion){
            case NINGUNO:
                ...
                this.tipoOperacion = ClienteController.tipo.NUEVO;
                break;
            case NUEVO:
                ...
                this.tipoOperacion = ClienteController.tipo.NINGUNO;
                break;
            case MODIFICAR:
                this.btnNuevo.setText("Nuevo");
                this.btnGuardar.setDisable(true);
    ...
    public void modificar(){
        if(this.tblCliente.getSelectionModel().getSelectedItem() != null){
            this.activarDesactivarControles(true);
            this.tipoOperacion = ClienteController.tipo.MODIFICAR;
            this.btnNuevo.setText("Cancelar");
            this.btnGuardar.setDisable(false);
            this.btnEliminar.setDisable(true);
            this.btnModificar.setDisable(true);
